  ...
  "rounded-xl border text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        glow: "bg-card border-primary/30 shadow-[0_0_30px_hsl(142_76%_45%/0.2)]",
        interactive: "bg-card border-border hover:border-primary/50 hover:shadow-[0_0_20px_hsl(142_76%_45%/0.2)] cursor-pointer",
      },
    },
    defaultVariants: {
      variant: "default",
